...
Future<void> main() async {
  ...
  group('Google Maps Places', () {
    ...
    group('textsearch build url', () {
      ...
      test('basic', () {
        expect(
          ...
          _uri
              .replace(
                queryParameters: {'query': '123 Main Street', 'key': apiKey},
              )
              .toString(),
        );
      });
      ...
      test('with type', () {
        expect(
          places.buildTextSearchUrl(query: '123 Main Street', type: 'hospital'),
          _uri
              .replace(
                queryParameters: {
                  'query': '123 Main Street',
    ...
    group('details build url', () {
      ...
      test('with place_id', () {
        expect(
          ...
          _uri
              .replace(queryParameters: {'placeid': 'PLACE_ID', 'key': apiKey})
              .toString(),
        );
      });
      ...
      test('with reference', () {
        expect(
          ...
          _uri
              .replace(queryParameters: {'reference': 'REF', 'key': apiKey})
              .toString(),
        );
      });
    ...
    group('autocomplete build url', () {
      ...
      test('basic', () {
        expect(
          ...
          _uri
              .replace(queryParameters: {'input': 'Amoeba Test', 'key': apiKey})
              .toString(),
        );
      });
      ...
      test('with offset', () {
        expect(
          places.buildAutocompleteUrl(input: 'Amoeba Test', offset: 3),
          _uri
              .replace(
                queryParameters: {
                  'input': 'Amoeba Test',
      ...
      test('with radius', () {
        expect(
          places.buildAutocompleteUrl(input: 'Amoeba Test', radius: 500),
          _uri
              .replace(
                queryParameters: {
                  'input': 'Amoeba Test',
      ...
      test('with language', () {
        expect(
          places.buildAutocompleteUrl(input: 'Amoeba Test', language: 'fr'),
          _uri
              .replace(
                queryParameters: {
                  'input': 'Amoeba Test',
      ...
      test('with strictbounds', () {
        expect(
          places.buildAutocompleteUrl(input: 'Amoeba Test', strictbounds: true),
          _uri
              .replace(
                queryParameters: {
                  'input': 'Amoeba Test',
    ...
    group('queryautocomplete', () {
      ...
      test('with offset', () {
        expect(
          places.buildQueryAutocompleteUrl(input: 'Amoeba Test', offset: 3),
          _uri
              .replace(
                queryParameters: {
                  'input': 'Amoeba Test',
      ...
      test('with radius', () {
        expect(
          places.buildQueryAutocompleteUrl(input: 'Amoeba Test', radius: 500),
          _uri
              .replace(
                queryParameters: {
                  'input': 'Amoeba Test',
    ...
    test('decode search response', () {
      ...
      expect(
        response.results.first.altIds.first.placeId,
    ...
    test('decode autocomplete response', () {
      ...
      expect(
        p1.matchedSubstrings.first,
        MatchedSubstring(offset: 0, length: 5),
      );
      ...
      expect(p1.terms, [
        Term(offset: 0, value: 'Paris'),
        Term(offset: 7, value: 'France'),
      ]);
